...
ETCD_VERSION=${ETCD_VERSION:-v3.6.10-k3s2}
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.35.4}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.35.4-rke2r1-build20260416}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.35.1-0.20260415180542-6eb9d7c819d5-build20260415}
