...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.33.11}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.33.11-rke2r1-build20260416}
ETCD_VERSION=${ETCD_VERSION:-v3.6.7-k3s2}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.33.11-0.20260415182038-2566e39d309b-build20260416}
KLIPPERHELM_VERSION=${KLIPPERHELM_VERSION:-v0.9.17-build20260422}
