...
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.36.2-rke2r1-build20260612}
PAUSE_VERSION=${PAUSE_VERSION:-3.10.2}
CCM_VERSION=${CCM_VERSION:-v1.36.2-0.20260610225606-10b320a3ba51-build20260722}
KLIPPERHELM_VERSION=${KLIPPERHELM_VERSION:-v0.13.1-build20260715}
